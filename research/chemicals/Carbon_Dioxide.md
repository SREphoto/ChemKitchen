# Carbon Dioxide - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** CO2
- **Molecular Mass:** 44 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Gas
- **Melting Point:** -78.5°C
- **Boiling Point:** -56.6°C
- **Color:** Colorless, odorless gas.
- **Odor:** Sublimes at -78.5C

## Safety and Hazards
- **Primary Hazard:** Asphyxiant
...
## Description
Colorless, odorless gas. Sublimes at -78.5C. Product of combustion. Greenhouse gas. Used in carbonation.
