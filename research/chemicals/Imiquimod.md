# Imiquimod - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C14H16N4
- **Molecular Mass:** 240 g/mol (rounded to nearest whole number)
...
## Description
White to off-white crystalline powder. Immune response modifier. Toll-like receptor 7 agonist. Used for genital warts, actinic keratosis.
