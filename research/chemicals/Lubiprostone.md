# Lubiprostone - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C20H32F2O5
- **Molecular Mass:** 390 g/mol (rounded to nearest whole number)
...
## Description
White crystalline powder. Chloride channel activator. Bicyclic fatty acid derivative. Used for chronic constipation, IBS-C.
