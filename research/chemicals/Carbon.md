# Carbon - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C
- **Molecular Mass:** 12 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Solid
- **Melting Point:** 3550°C
- **Boiling Point:** 4827°C
- **Color:** Exists as graphite (black, slippery) or diamond (clear, hard).
- **Odor:** Also amorphous carbon (soot, charcoal)

## Safety and Hazards
- **Primary Hazard:** Combustible dust
...
- **Legality:** Generally legal with standard laboratory restrictions.
- **Insurance Needs:** Standard laboratory insurance required.

## Description
Exists as graphite (black, slippery) or diamond (clear, hard). Also amorphous carbon (soot, charcoal). Essential for organic chemistry.
