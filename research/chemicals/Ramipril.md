# Ramipril - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C23H32N2O5
- **Molecular Mass:** 416 g/mol (rounded to nearest whole number)
...
## Description
White crystalline powder. ACE inhibitor. Prodrug (converted to ramiprilat). Used for hypertension, heart failure.
