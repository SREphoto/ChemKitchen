# Verapamil - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C27H38N2O4
- **Molecular Mass:** 454 g/mol (rounded to nearest whole number)
...
## Description
White crystalline powder. Calcium channel blocker (Class IV). Used for hypertension, angina, arrhythmias. Phenylalkylamine.
