# Epinephrine - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C9H13NO3
- **Molecular Mass:** 183 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Solid
- **Melting Point:** 212°C
- **Boiling Point:** Decomposes
- **Color:** White to brownish powder.
- **Odor:** Odorless (typical for pharmaceutical powders)

## Safety and Hazards
- **Primary Hazard:** Toxic, vasoconstrictor
...
## Description
White to brownish powder. Catecholamine hormone/neurotransmitter. Degrades on exposure to light/air. Used for anaphylaxis.
