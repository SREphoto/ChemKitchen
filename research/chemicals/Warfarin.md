# Warfarin - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C19H16O4
- **Molecular Mass:** 308 g/mol (rounded to nearest whole number)
...
## Safety and Hazards
- **Primary Hazard:** Highly toxic, teratogenic
...
## Description
White crystalline powder. Anticoagulant (vitamin K antagonist). Used for blood clot prevention. Narrow therapeutic index. Monitoring required (INR).
