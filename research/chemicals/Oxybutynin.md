# Oxybutynin - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C22H31NO3
- **Molecular Mass:** 357 g/mol (rounded to nearest whole number)
...
## Description
White crystalline powder. Antimuscarinic for overactive bladder. Used for urinary incontinence. Tertiary amine. Also used for hyperhidrosis.
