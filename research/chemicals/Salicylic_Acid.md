# Salicylic Acid - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C7H6O3
- **Molecular Mass:** 138 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Solid
- **Melting Point:** 158.6°C
- **Boiling Point:** 211°C
- **Color:** White crystalline powder.
- **Odor:** Weak acid (pKa = 2.97)

## Safety and Hazards
- **Primary Hazard:** Irritant, toxic in high doses
...
## Description
White crystalline powder. Weak acid (pKa = 2.97). Precursor to aspirin. Used in skincare.
