# Rosuvastatin - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C22H28FN3O6S
- **Molecular Mass:** 481 g/mol (rounded to nearest whole number)
...
## Description
White to off-white powder. Statin (HMG-CoA reductase inhibitor). Used for hypercholesterolemia. Most potent statin.
