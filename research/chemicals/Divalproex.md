# Divalproex - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C16H32O5 (valproate complex)
- **Molecular Mass:** 288 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Solid
- **Melting Point:** Complex°C
- **Boiling Point:** Decomposes
- **Color:** White crystalline powder.
- **Odor:** Odorless (typical for pharmaceutical powders)

## Safety and Hazards
- **Primary Hazard:** Moderate toxicity, teratogenic
...
- **Legality:** Generally legal with standard laboratory restrictions. May require prescription for use.
- **Insurance Needs:** Standard laboratory insurance required. Additional coverage may be needed for controlled substances.

## Description
White crystalline powder. Valproate semisodium. Used for epilepsy, bipolar disorder, migraine. Hepatotoxicity risk. Neural tube defect risk.

## Solubility
Consult SDS for specific solubility data. Typically poorly soluble in water, soluble in organic solvents (ethanol, DMSO, DMF).
