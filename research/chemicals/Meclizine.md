# Meclizine - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C25H27ClN2
- **Molecular Mass:** 391 g/mol (rounded to nearest whole number)
...
## Description
White to yellow crystalline powder. Antihistamine/antiemetic. Used for motion sickness, vertigo. Piperazine derivative.
