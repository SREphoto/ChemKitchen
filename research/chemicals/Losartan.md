# Losartan - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C22H23ClN6O
- **Molecular Mass:** 422 g/mol (rounded to nearest whole number)
...
## Description
White to off-white powder. ARB antihypertensive. First-in-class. Used for hypertension, diabetic nephropathy. Active metabolite.
