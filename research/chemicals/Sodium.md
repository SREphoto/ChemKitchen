# Sodium - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** Na
- **Molecular Mass:** 23 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Solid
- **Melting Point:** 97.8°C
- **Boiling Point:** 883°C
- **Color:** Soft, silvery-white alkali metal.
- **Odor:** Extremely reactive with water (produces H2, exothermic)

## Safety and Hazards
- **Primary Hazard:** Reactive metal, corrosive
...
## Description
Soft, silvery-white alkali metal. Extremely reactive with water (produces H2, exothermic). Stored under oil.
