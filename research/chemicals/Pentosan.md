# Pentosan - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** Varies (polysulfated polysaccharide)
- **Molecular Mass:** -2000 g/mol (rounded to nearest whole number)
...
## Description
White to off-white powder. Semi-synthetic glycosaminoglycan. Used for interstitial cystitis. Anticoagulant activity. Polysulfated pentose polymer.
