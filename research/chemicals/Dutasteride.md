# Dutasteride - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C27H30F6N2O2
- **Molecular Mass:** 528 g/mol (rounded to nearest whole number)
...
## Description
White to pale yellow powder. 5-alpha-reductase inhibitor. Used for BPH. Contraindicated in pregnancy (male fetal development risk).
