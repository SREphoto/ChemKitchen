# Glimepiride - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C24H34N4O5S
- **Molecular Mass:** 490 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Solid
- **Melting Point:** 212°C
- **Boiling Point:** Decomposes
- **Color:** White to yellow crystalline powder.
- **Odor:** Odorless (typical for pharmaceutical powders)

## Safety and Hazards
- **Primary Hazard:** Low acute toxicity
...
## Description
White to yellow crystalline powder. Sulfonylurea antidiabetic. Stimulates insulin secretion. Used for type 2 diabetes.
