# Fluorine - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** F2
- **Molecular Mass:** 38 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Gas
- **Melting Point:** -219.7°C
- **Boiling Point:** -188.1°C
- **Color:** Pale yellow gas.
- **Odor:** Most electronegative element

## Safety and Hazards
- **Primary Hazard:** Extremely toxic, corrosive
...
## Description
Pale yellow gas. Most electronegative element. Reacts with almost everything. Used in fluorochemicals.
