# Oxygen - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** O2
- **Molecular Mass:** 32 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Gas
- **Melting Point:** -218.8°C
- **Boiling Point:** -183°C
- **Color:** Colorless, odorless, tasteless gas.
- **Odor:** Supports combustion

## Safety and Hazards
- **Primary Hazard:** Oxidizer, fire risk
...
## Description
Colorless, odorless, tasteless gas. Supports combustion. Essential for respiration. Liquid oxygen is pale blue.
