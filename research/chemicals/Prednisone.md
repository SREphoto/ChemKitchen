# Prednisone - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C21H26O5
- **Molecular Mass:** 358 g/mol (rounded to nearest whole number)
...
## Description
White crystalline powder. Corticosteroid prodrug (converted to prednisolone). Used for inflammation, autoimmune disorders, transplant.
