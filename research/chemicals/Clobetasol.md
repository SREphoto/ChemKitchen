# Clobetasol - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C22H28ClFO5
- **Molecular Mass:** 427 g/mol (rounded to nearest whole number)
...
## Description
White to off-white powder. Very potent topical corticosteroid. Used for psoriasis, eczema, dermatitis. Atrophy risk with prolonged use.
