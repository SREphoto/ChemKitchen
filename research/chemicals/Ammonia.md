# Ammonia - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** NH3
- **Molecular Mass:** 17 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Gas
- **Melting Point:** -77.7°C
- **Boiling Point:** -33.3°C
- **Color:** Colorless gas with sharp, pungent odor.
- **Odor:** Strong base in aqueous solution

## Safety and Hazards
- **Primary Hazard:** Toxic, corrosive
...
## Description
Colorless gas with sharp, pungent odor. Strong base in aqueous solution. Used in fertilizer.
