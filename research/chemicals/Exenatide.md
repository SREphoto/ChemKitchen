# Exenatide - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C184H282N50O60S
- **Molecular Mass:** 4187 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Solid
- **Melting Point:** N/A (peptide)°C
- **Boiling Point:** Decomposes
- **Color:** White to off-white powder (lyophilized).
- **Odor:** Odorless (typical for pharmaceutical powders)

## Safety and Hazards
- **Primary Hazard:** Low toxicity
...
## Description
White to off-white powder (lyophilized). GLP-1 receptor agonist. Injectable antidiabetic. Synthetic peptide. Exenatide is synthetic exendin-4.
