# Phenol - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C6H5OH
- **Molecular Mass:** 94 g/mol (rounded to nearest whole number)
- **State at Room Temperature:** Solid
- **Melting Point:** 40.5°C
- **Boiling Point:** 181.7°C
- **Color:** White crystalline solid with sweet, tarry odor.
- **Odor:** Weak acid (pKa = 10)
...
## Description
White crystalline solid with sweet, tarry odor. Weak acid (pKa = 10). Burns skin. Used in antiseptics.
