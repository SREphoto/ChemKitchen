# Dicyclomine - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C19H35NO2
- **Molecular Mass:** 309 g/mol (rounded to nearest whole number)
...
## Description
White crystalline powder. Antimuscarinic/antispasmodic. Used for IBS. Tertiary amine structure. CNS side effects possible.
