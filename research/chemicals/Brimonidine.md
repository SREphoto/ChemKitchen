# Brimonidine - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C11H10BrN5
- **Molecular Mass:** 292 g/mol (rounded to nearest whole number)
...
## Description
White to off-white powder. Alpha-2 adrenergic agonist. Used for glaucoma (eye drops). Also for rosacea.
