# Fluticasone - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C22H27F3O4S
- **Molecular Mass:** 444 g/mol (rounded to nearest whole number)
...
## Description
White crystalline powder. Inhaled corticosteroid. Used for asthma, COPD, allergic rhinitis. High first-pass metabolism (safer).
