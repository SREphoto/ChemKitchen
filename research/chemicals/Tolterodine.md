# Tolterodine - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C22H31NO
- **Molecular Mass:** 325 g/mol (rounded to nearest whole number)
...
## Description
White crystalline powder. Antimuscarinic for overactive bladder. Used for urinary incontinence. Competitive M3 receptor antagonist.
