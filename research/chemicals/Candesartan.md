# Candesartan - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C24H20N6O3
- **Molecular Mass:** 440 g/mol (rounded to nearest whole number)
...
## Description
White to off-white powder. Angiotensin II receptor blocker (ARB). Used for hypertension. Tetrazole derivative. Prodrug.
