# Nebivolol - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C22H25F2NO4
- **Molecular Mass:** 405 g/mol (rounded to nearest whole number)
...
## Description
White crystalline powder. Beta-1 selective blocker with NO-mediated vasodilation. Used for hypertension. Racemic mixture.
