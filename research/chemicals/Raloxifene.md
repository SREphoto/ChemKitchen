# Raloxifene - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C28H27NO4S
- **Molecular Mass:** 473 g/mol (rounded to nearest whole number)
...
## Description
White crystalline powder. SERM (Selective Estrogen Receptor Modulator). Used for osteoporosis, breast cancer risk reduction. Benzothiophene derivative.
