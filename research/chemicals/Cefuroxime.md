# Cefuroxime - Chemical Compound Research

## Basic Properties
- **Molecular Formula:** C16H16N4O8S
- **Molecular Mass:** 424 g/mol (rounded to nearest whole number)
...
## Safety and Hazards
- **Primary Hazard:** Low toxicity, allergen
...
## Description
White to pale yellow powder. Second-generation cephalosporin antibiotic. Broad-spectrum. Beta-lactam. Administered IV/IM or orally (axetil).
