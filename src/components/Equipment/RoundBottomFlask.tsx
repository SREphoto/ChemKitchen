...
export default function RoundBottomFlask({ ingredientName, fillLevel, activeAction, position = [0, 0, 0] }: RoundBottomFlaskProps) {
  const { scene } = useGLTF('/models/glassware/round_bottom_flask.glb');
